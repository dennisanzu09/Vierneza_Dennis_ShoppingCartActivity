...
This project is a console-based Shopping Cart System developed in C#. It simulates a simple store where users can select products, input quantities, and view a receipt after checkout. 
